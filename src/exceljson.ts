  ...
  public static processWorkbookFromXLSX(f: any, filename: string) {
    ...
    for (const sheetName of sheetNames) {
      ...
      output['worksheets'].push({
        ...
        formulas: ExcelJSON.processWorksheet(
          sheets[sheetName],
          ExcelJSON.selections.FORMULAS
        ),
        values: ExcelJSON.processWorksheet(
          sheets[sheetName],
          ExcelJSON.selections.VALUES
        ),
        styles: ExcelJSON.processWorksheet(
          sheets[sheetName],
          ExcelJSON.selections.STYLES
        ),
      });
    }
    return output;
